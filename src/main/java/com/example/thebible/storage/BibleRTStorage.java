...
public interface BibleRTStorage {
     ...
     */
    List<BibleRTResponseDto> getTodayBibleRTWords();
     ...
     */
    void updateTodayBibleWords(List<BibleRTResponseDto> todayBibleWords, Boolean isAdd);
}
